...
var ownerAccount, charityAccount, investorAccount1, investorAccount2, iRewardFarm, iRegistry, iToken, iGlobalParams, iPriceOracle, iDistribution, iCampaignFactory;
contract("HEORewardFarm", (accounts) => {
    before(async () => {
        ...
        await iDistribution.distribute(charityAccount, web3.utils.toWei("100"), {from: ownerAccount});
    ...
    it("Should calculate full reward of 0.2 ETH (1 HEO) after 12 reward periods of 2s each with constant HEO price of 0.2ETH by donating 1ETH to a campaign with Y=0.2", async() => {
        ...
        /*for(var i=0; i<12;i++) {
            ...
            console.log(`Price @ period ${i}: ${price}`);
        }*/
    ...
    /*it("Should calculate full reward after max reward periods with changing price", async() => {
        //Set price
        //Make donation
        //Advance time and change price several times
        //Check reward
    });*/
});
//200000000000000000
//400000000000000000
//2000000000000000000
//5479452054794520547945205479452054
